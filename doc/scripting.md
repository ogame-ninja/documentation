...
LfBuildingsArr = [RESIDENTIALSECTORID, BIOSPHEREFARMID, RESEARCHCENTREID, ACADEMYOFSCIENCESID, NEUROCALIBRATIONCENTREID, HIGHENERGYSMELTINGID, FOODSILOID, FUSIONPOWEREDPRODUCTIONID, SKYSCRAPERID, BIOTECHLABID, METROPOLISID, PLANETARYSHIELDID]
